...
Если ваше устройство поддерживает аппаратное или программное ускорение (flow offloading, hardware nat, hardware acceleration), то iptables работать не будут.
...
В новых ядрах (и в более старых, openwrt портировал изменение на 4.14) присутствует software offloading.
Пакеты, проходящие через software offloading, так же проходят мимо большинства механизмов iptables.
Offload включается через специальный target в iptables. Не обязательно пропускать весь трафик через offload.
