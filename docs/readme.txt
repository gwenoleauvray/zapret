...
Размер листов РКН достиг порога, когда не хвататет 64 Mb RAM для хранения ipset
и обработки временных файлов в /tmp. До какого-то предела будет спасать swap, если на роутере есть usb
и в него воткнута флэшка. Но уже сейчас очевидна необходимость иметь 128+ Mb RAM для работы с этими листами.
