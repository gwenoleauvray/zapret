...
добавлять tcp option "MD5 signature". Последний вариант работает не всегда, применять с осторожностью. Лучше всего выяснить на каком
хопе у вас DPI и настроить соответственно TTL.
