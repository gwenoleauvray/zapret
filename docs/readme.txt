...
добавлять tcp option "MD5 signature". Последний вариант работает не всегда, применять с осторожностью. Если вы ваше устройство за NAT,
NAT может не пропускать пакеты с инвалидной чексуммой. Лучше всего выяснить на каком хопе у вас DPI и настроить соответственно TTL.
