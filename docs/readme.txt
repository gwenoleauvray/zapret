...
Алгоритмы поиска подсетей для ipv4 и ipv6 существенно различаются.

Для ipv4 выбирается подсеть максимального размера (префикс меньше), в которой заполнен указанный процент адресов (3/4 = 75%).

Для ipv6 выбирается подсеть, в которой присутствует указанный минимум адресов.
Размер ipv6 подсети выбирается следующим алгоритмом :
...
Требуемое процессорное время для вычислений сильно зависит от ширины диапазона длин префиксов и длины листа.
Если ip2net думает слишком долго, сократите диапазон.
